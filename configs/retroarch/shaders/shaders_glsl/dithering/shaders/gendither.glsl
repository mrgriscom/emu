...
void main()
{
    ...
    _a0049 = _ditheu.x/4.00000000E+00;
    _TMP37 = abs(_a0049);
    _TMP38 = fract(_TMP37);
    _TMP39 = abs(4.00000000E+00);
    _c0047 = _TMP38*_TMP39;
    if (_ditheu.x < 0.00000000E+00) { 
        _TMP40 = -_c0047;
    } else {
        _TMP40 = _c0047;
    } 
    _TMP16 = _TMP40;
    _a0057 = _ditheu.y/4.00000000E+00;
    _TMP37 = abs(_a0057);
    _TMP38 = fract(_TMP37);
    _TMP39 = abs(4.00000000E+00);
    _c0055 = _TMP38*_TMP39;
    if (_ditheu.y < 0.00000000E+00) { 
        _TMP40 = -_c0055;
    } else {
        _TMP40 = _c0055;
    } 
    _ditdex = int(_TMP16)*4 + int(_TMP40);
